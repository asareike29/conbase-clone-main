                ...
                <Link to="/signin">
                  <button
                    style={{
                      ...
                      fontSize: "15px", fontWeight: 600, cursor: "pointer",
                      padding: "8px 16px", borderRadius: "8px", transition: "background 0.15s",
                    }}
                    onMouseEnter={(e) => e.currentTarget.style.background = "rgba(255,255,255,0.06)"}
                    onMouseLeave={(e) => e.currentTarget.style.background = "transparent"}
                  >
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", padding: "16px 0", display: "flex", flexDirection: "column", gap: "4px" }}>
            ...
            {user && (
              <Link
                to="/profile"
                onClick={() => setMobileOpen(false)}
                style={{ color: "#8a919e", textDecoration: "none", fontSize: "16px", fontWeight: 500, padding: "12px 8px", borderRadius: "8px", display: "block" }}
              >
                My Profile
              </Link>
            )}
