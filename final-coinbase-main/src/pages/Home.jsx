...
export default function Home() {
  ...
  const features = [
    {
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#0052ff" strokeWidth="2">
    ...
    <div style={{ background: "#0a0b0d", minHeight: "100vh" }}>
      ...
      >
        ...
        <div>
          ...
          >
            ...
            <span
              style={{
                background: "linear-gradient(135deg, #0052ff 0%, #4da6ff 100%)",
          ...
          <p
            ...
            style={{ fontSize: "18px", color: "#8a919e", lineHeight: 1.7, marginBottom: "40px" }}
          >
          ...
          >
            ...
            <button
              ...
              style={{ padding: "14px 28px", fontSize: "15px", flexShrink: 0 }}
            >
              Get started
            </button>
          </div>
          ...
          <p
            ...
            style={{ fontSize: "13px", color: "#8a919e", marginTop: "16px" }}
          >
        ...
        <div className="animate-fade-in-up delay-200 hero-card-side" style={{ position: "relative" }}>
          ...
          >
            ...
            <div style={{
              ...
              background: "radial-gradient(ellipse at 50% -20%, rgba(0,82,255,0.15) 0%, transparent 60%)",
              pointerEvents: "none",
            }} />
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
              <div>
                ...
                <div style={{ fontSize: "28px", fontWeight: 700, color: "#ffffff" }}>$67,423</div>
              </div>
              <span style={{
      ...
      <section style={{ maxWidth: "1280px", margin: "0 auto", padding: "96px 24px" }}>
        <div style={{ textAlign: "center", marginBottom: "64px" }}>
          <h2 style={{ fontSize: "clamp(28px,4vw,48px)", fontWeight: 800, margin: "0 0 16px", letterSpacing: "-0.02em" }}>
            Why choose Coinbase?
          </h2>
          ...
          {features.map((f, i) => (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 16px 48px rgba(0,82,255,0.1)";
              }}
              onMouseLeave={(e) => {
      ...
      <section style={{ background: "#0d0e10", padding: "80px 24px" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "40px", flexWrap: "wrap", gap: "16px" }}>
            <div>
              <h2 style={{ fontSize: "clamp(24px,3vw,36px)", fontWeight: 800, margin: "0 0 8px", letterSpacing: "-0.02em" }}>
                Top assets
              </h2>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      <div style={{
                        ...
                        background: asset.color + "20",
                        display: "flex", alignItems: "center", justifyContent: "center",
                        fontSize: "14px", fontWeight: 700, color: asset.color,
