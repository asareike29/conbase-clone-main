      ...
      <div style={{ width: "100%", maxWidth: "460px" }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <input
                ...
                style={{
                  width: "100%",
                  background: "#1c1d20",
                  border: `1px solid ${errors.password ? "#f04124" : "rgba(255,255,255,0.1)"}`,
                  borderRadius: "10px",
                  padding: "14px 16px",
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <button
                ...
                onClick={() => setStep(1)}
                style={{ padding: "16px 24px", fontSize: "15px", flex: "0 0 auto" }}
              >
                ← Back
              </button>
              <button
        ...
        {step < 3 && (
          <p style={{ textAlign: "center", color: "#8a919e", fontSize: "14px", marginTop: "24px" }}>
            ...
            <Link to="/signin" style={{ color: "#0052ff", fontWeight: 600, textDecoration: "none" }}>
              Sign in
            </Link>
          </p>
        )}
